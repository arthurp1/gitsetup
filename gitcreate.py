...
github_create_repo = "curl -u {0} https://api.github.com/user/repos -d \'{{\"name\" : \"{1}\"}}\' --silent".format(user, repo)
github_add_remote = "git remote add origin git@github.com:{0}/{1}.git --silent".format(user, repo)
gitpush = "git push --set-upstream origin master --silent"
